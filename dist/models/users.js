...
var ColectionUsers = "users";

//creacion del esquema de usuarios
var SchemaUsers = new _mongoose["default"].Schema({
  email: {
    type: String,
    require: true,
    unique: true
...
SchemaUsers.methods.encryptPassword = /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          _context.next = 3;
          return _bcryptjs["default"].genSalt(15);
        case 3:
          encrypt = _context.sent;
          _context.next = 6;
          return _bcryptjs["default"].hash(password, encrypt);
        case 6:
...
SchemaUsers.methods.comparePassword = /*#__PURE__*/function () {
...
var modelUsers = new _mongoose["default"].model(ColectionUsers, SchemaUsers);
var _default = modelUsers;
